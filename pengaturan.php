...
<div class="container">
	...
	<tr>
		...
		<?php
			...
			{
			    if (!preg_match("/^[a-zA-Z0-9]/",$_POST["matkul"]))
					$error = "Kode Matkul Tidak boleh kosong!";
				...
				else
				{
					...
					$cek = checkJadwal($_POST['matkul']);
					//var_dump($cek);
					if ($cek) {
                        $error = "Matakuliah sudah ada!";
                    }
					else
					{
						$matkul = $_POST["matkul"];
						...
						$jam = $_POST["jam"];
						$kelas = $_POST["kelas"];
                        registerJadwal($matkul, $nama, $jurusan, $shift, $sks, $semester, $namadosen, $hari, $jam, $kelas);
